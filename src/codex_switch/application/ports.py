...
class Profiles(Protocol):
    ...
    def login(self, name: str, *, proxy: str | None = None, provider: str | None = None) -> ProfileStatus: ...
    def run(self, name: str, args: list[str], *, proxy: str | None = None) -> int: ...
    def provider_choices(self): ...
    def validate_arguments(self, name: str, args: list[str]) -> None: ...
    def resume_arguments(self, name: str) -> list[str]: ...
